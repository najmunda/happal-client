...
export default function Mine() {
  ...
  return success ? (
    ...
    <main
      ...
      className="container w-dvw md:w-full flex-1 pb-2 px-2 flex flex-col bg-inherit"
    >
        ...
        <>
          <section className="py-2 flex gap-2 sticky top-14 bg-inherit z-10 overflow-y-auto">
            <Link
              ...
              className="p-2 flex items-center justify-center gap-2 bg-white text-nowrap shadow rounded-lg hover:shadow-md"
              to="help"
            >
              <HelpCircle size={20} />
              Bantuan
