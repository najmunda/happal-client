...
export default function About() {
  return (
    <main className={`container w-dvw md:w-full flex-1 flex flex-col justify-center items-center gap-2 p-2`}>
      <div
        className="w-full flex-1 md:max-w-sm md:max-h-[35rem] p-2 flex flex-col justify-center items-center gap-3 bg-white text-center rounded-lg shadow"
      >
        ...
        <p className="text-sm">Dibangun dengan:</p>
        <ul className="flex justify-center items-center flex-wrap gap-2 text-xs">
